...
REG_BLOCK_VOLTAGE       = 0x0000    # decimal register 0
REG_CELLS_VOLTAGE       = 0x0028    # decimal register 40
REG_TEMPERATURE         = 0x0078    # decimal register 120
REG_EXTRA_TEMPERATURE   = 0x0091    # decimal register 145

LEN_BLOCK_VOLTAGE       = 0x10      # decimal count 16
LEN_CELLS_VOLTAGE       = 0x10      # decimal count 16
LEN_TEMPERATURE         = 0x04      # decimal count 4
LEN_EXTRA_TEMPERATURE   = 0x0A      # decimal count 10

# Inverter register addresses
REG_INVERTER_PROTOCOL = 0x0020      # decimal register 32

# Modbus function codes
FUNC_READ_HOLDING_REGS = 0x03       # decimal 3
FUNC_WRITE_MULTIPLE_REGS = 0x10     # decimal 16
FUNC_WRITE_SINGLE_REG = 0x06        # decimal 6

# Supported by BMS inverter protocols codes (decimal register 32)
INVERTER_PROTOCOLS = {
