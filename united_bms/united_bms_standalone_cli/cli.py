...
def main():
    ...
    parser.add_argument('--write', type=parse_write_argument, help='ONLY AT YOUR OWN RISK! Write format: <register=value>')
    ...
    if args.tcp:
        ...
        print("❌ Please specify either --tcp or --serial. Read help by specify -h")
        return
